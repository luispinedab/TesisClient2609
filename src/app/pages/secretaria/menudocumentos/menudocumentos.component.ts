...
@Component({
  selector: 'ngx-menudocumentos',
  templateUrl: './menudocumentos.component.html',
  styleUrls: ['./menudocumentos.component.scss']
})
export class MenudocumentosComponent implements OnInit {
  anios:any=[];
  levelgrades:any=[];
  ...
  guardar(){
    ...
    this.router.navigate(['/pages/secretaria/verDocumentos/tabla'], { state: this.miFormulario.value });
  }
}
