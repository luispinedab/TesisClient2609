...
@Component({
  selector: 'ngx-consultarobservacion',
  templateUrl: './consultarobservacion.component.html',
  styleUrls: ['./consultarobservacion.component.scss']
})
export class ConsultarobservacionComponent implements OnInit {
  estudiante:any;
  ...
  console.log(objeto)
  this.router.navigate(['/pages/comite/observaciones-ver/tabla'], { state: objeto });
  }
